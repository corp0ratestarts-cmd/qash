...
## Crypto-game scaffolding

- `crypto_game_framework.v` adds a shared game-based interface (adversary/oracle/advantage, PRF skeleton, AU-MAC skeleton) to support migration from axioms to mechanised proofs for TH-10, Blinding PRF, and IT-MAC.
