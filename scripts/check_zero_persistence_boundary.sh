...
# WAL modules, commitment inbox/transport/recovery/backpressure, graph
# non-publication, and public transcript surfaces must remain commitment-only.
...
cargo test -p qash-pal --features zero-persistence --test commitment_backpressure
...
checks = [
    (
        [
            ...
            Path('crates/pal/src/commitment_backpressure.rs'),
