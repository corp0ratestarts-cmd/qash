...
impl TxMvpReceiptCommit {
    ...
    pub fn public_export(
        &self,
    ) -> Result<TxMvpReceiptCommitPublicExport, TxMvpReceiptCommitError> {
...
mod tests {
    use super::{
        TxMvpReceiptCommit, TxMvpReceiptCommitError, TX_MVP_PUBLIC_EXPORT_BYTES,
        TX_MVP_RECEIPT_COMMIT_BYTES, TX_MVP_RECEIPT_COMMIT_DOMAIN_TAG,
        TX_MVP_RECEIPT_COMMIT_VERSION,
    };
