...
The project will pursue **offline incident-log attestation** as the first MVP use case.

This is preferred over payment, energy settlement, credential, or general audit-rail demos because it is the lowest-cost, lowest-regulatory, and fastest demonstrator that still exercises QASH's core differentiator: deterministic replay of commitment-only evidence without publishing a transaction graph.
...
- TRL uplift note for grant applications.
